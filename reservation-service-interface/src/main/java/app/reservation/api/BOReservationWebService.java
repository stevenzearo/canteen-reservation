...
public interface BOReservationWebService {
    ...
    @PUT
    @Path("/bo/reservation")
    BOSearchReservationResponse search(BOSearchReservationRequest request); // admin can search via reserving time range/user name/restaurant name/reservation status
}
