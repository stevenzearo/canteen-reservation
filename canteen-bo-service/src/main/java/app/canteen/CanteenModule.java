...
public class CanteenModule extends Module {
    ...
    protected void initialize() {
        ...
        http().bean(UserStatusAJAXView.class);
        ...
        http().route(PUT, "/canteen/ajax/restaurant/:id", restaurantAJAX::update);
        http().route(POST, "/canteen/ajax/restaurant/:id/meal", mealAJAX::create);
        http().route(POST, "/canteen/ajax/user", userAJAX::createUser);
        http().route(PUT, "/canteen/ajax/user", userAJAX::search);
        http().route(PUT, "/canteen/ajax/user/:id/status", userAJAX::updateStatus);
        http().route(PUT, "/canteen/ajax/user/:id/password", userAJAX::resetPassword);
